$(function(){
	...
	$('#register').on('click', function(event){
		...
		$ncq1=$('#cq1').val().trim();  	$ncq2=$('#cq2').val().trim();
	
		//removes spaces from inputs
		var ans1=$("#answer1 ").val();	var ans2=$("#answer2").val();
		...
		if ( error_found == 1){
			...
			$.ajax({
				type: "POST",                      // type
				url: "account_blog_credential_register.php",           // request file the 'check_uname2.php'
