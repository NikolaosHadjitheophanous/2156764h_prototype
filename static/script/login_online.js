$(function(){
	...
	$('#login_btn').on('click', function(event){ 
		...
		$.ajax({
			type: "POST", // type
			url: "OnlineShopping_loginQuestion.php", // request file the 'credentialcheck.php'
		...
		$.ajax({
			...
			success: function(responseText) { 
                 ...
                 if(responseText == "1") { 
				window.location = 'OnlineShopping_loginImage.php'; // redirect	
	         }else{
