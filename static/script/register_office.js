$(function(){
	...
	$('#register').on('click', function(event){
		...
		var ans1=$("#answer1 ").val().trim();     var ans2=$("#answer2").val().trim();
		...
		if ( error_found == 1){
			...
			var datastring ='&username='+username+'&email='+email+'&memorable='+memorable+'&answer1='+ans1+'&answer2='+ans2+ '&ncq1='+$ncq1+'&ncq2='+ $ncq2+'&question1=' +inputQuestion1 +'&question2=' + inputQuestion2;
			$.ajax({
				type: "POST",                      // type
				url: "OfficeEmail_register.php",           // request file the 'check_uname2.php'
				data: datastring,                  // post the data
				success: function (response) {
					// ajax success callback
					var result = $.trim(response);
					if(result === "1" ){
						window.location = 'success_registration.php'; // redirec
					}else{
